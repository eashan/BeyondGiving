...
ngo = api.model('NGO', {
    ...
    'name': fields.String(required=True, description='Ngo name'),
    'description': fields.String(required=True, description='NGO description')
    'password': fields.String(required=True, description='NGO Password')
